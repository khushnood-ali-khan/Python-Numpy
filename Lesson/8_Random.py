...
# Choose Random choice from array

fruit_rng = np.random.default_rng()
fruits = np.array(['Apple', 'Mango', 'Barry', ' Banana'])
choose = fruit_rng.choice(fruits)       # you can even define size
print(choose)